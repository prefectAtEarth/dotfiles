# Generated by Powerlevel10k configuration wizard on 2024-08-05 at 10:48 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    chezmoi                 # custom mark to show if shell is a chezmoi shell
  ...
  function prompt_chezmoi() {
    if [ -n "${CHEZMOI}" ];then
      p10k segment -f '#ff0022' -t 'chezmoi'
    fi
  }
